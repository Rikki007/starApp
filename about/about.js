    ...
    main.innerHTML = `
        <section class="about">
            <div class="about-container">
                <h2>О нас</h2>
                <p>
                    Добро пожаловать в наше приложение! Здесь космические явления и астрология оживают, превращаясь в увлекательный и познавательный опыт. Мы создаем пространство, где каждый может насладиться магией Вселенной, узнать что-то новое и просто получить удовольствие от взаимодействия с уникальным контентом. Наше приложение создано для развлечения и ни в коем случае не стремится задеть или оскорбить чувства людей, независимо от их национальности, вероисповедания или взглядов. Мы также не поощряем никаких противоправных или неэтичных действий. Все данные, предоставляемые приложением, носят ознакомительный характер, чтобы помочь вам насладиться астрологией и космическими явлениями в комфортном и безопасном формате.
                </p>
