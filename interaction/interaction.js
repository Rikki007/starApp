...
const interaction = () => {
    ...
    main.innerHTML = `
        <details class="rule__details">
            <summary class="rule__summary">Показать правила взаимодействия</summary>
            <section class="rule">
                <h3 class="rule__title">Правила взаимодействия:</h3>
                <p class="rule-description">Для получения описания взаимодействий знаков выберите два знака в списке выбора, а затем нажмите на кнопку «Получить». Выбранные знаки подсветятся на зодиакальной розе. Описание появится под списком выбора знаков.</p>
