const descNEw = [
...

    {
       ...
       "childhood": {
        ...
        "work": {
            "description": "В работе Стрелец проявляет себя как авантюрный новатор, предпочитающий проекты с глобальным масштабом и свободой действий. Он преуспевает в сферах, требующих оптимизма, коммуникации и умения видеть «большую картину»: образование, туризм, международные отношения, философия. Стрельцы ценят возможность учиться, путешествовать и вдохновлять других. Однако их нетерпеливость к рутине и склонность переоценивать свои силы могут приводить к незавершённым задачам. Идеальная работа для Стрельца — баланс между приключениями и смыслом.",
        ...
        "relationships": {
            "romantic": {
                "description": "Стрелец в романтических отношениях — это вдохновляющий авантюрист, для которого любовь — путь к новым горизонтам. Он дарит спонтанные поездки, обсуждает теорию струн на свиданиях и мечтает о партнёре-единомышленнике. Однако его страх «клетки» может проявляться в бегстве от обязательств. Идеальный партнёр для Стрельца — тот, кто разделит страсть к свободе, но мягко напомнит, что даже космонавты возвращаются на Землю."
            },

            "friend": {
                "description": "Стрелец в дружбе — генератор идей и душа авантюр. Он организует походы в горы ночью, притащит гитару к костру и заставит смеяться до слёз. Однако его дружба требует терпения: он может забыть о вашем дне рождения, увлёкшись планом кругосветки. Его слабость — неумение поддерживать в бытовых кризисах. Идеальный друг для Стрельца — тот, кто простит его рассеянность и вовремя остановит от необдуманных действий."
            },

            "foe": {
                "description": "Стрелец в роли врага — это прямолинейный критик, высмеивающий ваши принципы как «сковывающие цепи». Он не станет плести интриги — просто заявит при всех, что ваши идеи «пахнут нафталином». Его уязвимость — неприятие глубины: если вы раскроете поверхностность его аргументов, он уйдёт в глухую защиту. Главная опасность — его харизма: он легко переманит на свою сторону тех, кто жаждет «лёгкости бытия»."
            }
        }
    },
