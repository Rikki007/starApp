export const zodiacDescription = [
  {
    ...
    gems: [
      {
        name: "Diamond",
        positive: "Strength, clarity, determination.",
        protection: "Negative energies, fear, doubts.",
        picture: "./assets/images/stones/diamond.png",
      },
      {
        name: "Ruby",
        positive: "Passion, energy, courage.",
        protection: "Negative emotions, insecurity.",
        picture: "./assets/images/stones/ruby.png",
      },
      {
        name: "Carnelian",
        positive: "Inspiration, creativity, decisiveness.",
        protection: "Laziness, apathy.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Emerald",
        positive: "Love, harmony, stability.",
        protection: "Negative thoughts, stress.",
        picture: "./assets/images/stones/emerald.png",
      },
      {
        name: "Rose Quartz",
        positive: "Love, calmness, tenderness.",
        protection: "Emotional wounds, fear of love.",
        picture: "./assets/images/stones/roseQuartz.png",
      },
      {
        name: "Jade",
        positive: "Luck, peace, prosperity.",
        protection: "Negative energy, misfortune.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Agate",
        positive: "Balance, protection, harmony.",
        protection: "Negative energies, stress.",
        picture: "./assets/images/stones/agate.png",
      },
      {
        name: "Citrine",
        positive: "Confidence, joy, success.",
        protection: "Negative thoughts, failures.",
        picture: "./assets/images/stones/citrine.png",
      },
      {
        name: "Tiger's Eye",
        positive: "Courage, strength, protection.",
        protection: "Fears, insecurity.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Moonstone",
        positive: "Intuition, emotional balance, protection.",
        protection: "Negative energies, emotional stress.",
        picture: "./assets/images/stones/moonstone.png",
      },
      {
        name: "Pearl",
        positive: "Purity, calmness, protection.",
        protection: "Negative energies, emotional wounds.",
        picture: "./assets/images/stones/pearl.png",
      },
      {
        name: "Opal",
        positive: "Inspiration, creativity, harmony.",
        protection: "Negative thoughts, fears.",
  ...
  },
  {
    ...
    gems: [
      ...
      {
        name: "Sunstone",
        positive: "Vitality, joy, optimism.",
        protection: "Depression, gloom.",
        picture: "./assets/images/stones/sunstone.png",
      },
      {
        name: "Garnet",
        positive: "Strength, protection, passion.",
        protection: "Negative energies, emotional wounds.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Sapphire",
        positive: "Wisdom, honesty, purity.",
        protection: "Negative thoughts, stress.",
        picture: "./assets/images/stones/sapphire.png",
      },
      {
        name: "Peridot",
        positive: "Healing, cleansing, harmony.",
        protection: "Negative energies, illnesses.",
        picture: "./assets/images/stones/peridot.png",
      },
      {
        name: "Amazonite",
        positive: "Calmness, balance, confidence.",
        protection: "Fear, stress.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Opal",
        positive: "Harmony, love, beauty.",
        protection: "Negative energies, emotional wounds.",
        picture: "./assets/images/stones/opal.png",
      },
      {
        name: "Lapis Lazuli",
        positive: "Wisdom, honesty, calmness.",
        protection: "Negative thoughts, stress.",
        picture: "./assets/images/stones/lapisLazuli.png",
      },
      {
        name: "Turquoise",
        positive: "Protection, healing, peace.",
        protection: "Negative energies, illnesses.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Topaz",
        positive: "Strength, passion, protection.",
        protection: "Negative energies, emotional wounds.",
        picture: "./assets/images/stones/topaz.png",
      },
      {
        name: "Obsidian",
        positive: "Protection, cleansing, transformation.",
        protection: "Negative energies, evil spirits.",
        picture: "./assets/images/stones/obsidian.png",
      },
      {
        name: "Malachite",
        positive: "Protection, balance, transformation.",
        protection: "Negative thoughts, stress.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Turquoise",
        positive: "Wisdom, protection, luck.",
        protection: "Negative energies, illnesses.",
        picture: "./assets/images/stones/turquoise.png",
      },
      {
        name: "Amethyst",
        positive: "Spirituality, peace, protection.",
        protection: "Negative thoughts, stress.",
        picture: "./assets/images/stones/amethyst.png",
      },
      {
        name: "Citrine",
        positive: "Confidence, joy, success.",
  ...
  },
  {
    ...
    gems: [
      {
        name: "Garnet",
        positive: "Stability, strength, passion.",
        protection: "Negative energies, emotional wounds.",
        picture: "./assets/images/stones/garnet.png",
      },
      {
        name: "Onyx",
        positive: "Protection, strength, confidence.",
        protection: "Negative thoughts, stress.",
        picture: "./assets/images/stones/onyx.png",
      },
      {
        name: "Jet",
        positive: "Protection, healing, balance.",
        protection: "Negative energies, illnesses.",
  ...
  },
  {
    ...
    gems: [
      ...
      {
        name: "Aquamarine",
        positive: "Calmness, clarity, inspiration.",
        protection: "Negative energies, fear.",
        picture: "./assets/images/stones/aquamarine.png",
      },
      {
        name: "Garnet",
        positive: "Strength, protection, passion.",
  ...
  },
  {
    ...
    gems: [
      ...
      {
        name: "Bloodstone",
        positive: "Protection, healing, strength.",
        protection: "Negative energies, illnesses.",
