"cz": [
        {
            ...
            "description": {
                ...
                "common": "Berani jsou skutečnými hybateli pokroku, pohánění ohněm vášně a nadšení. Jejich energie, čerpaná z Marsu, z nich dělá neochvějné průkopníky, připravené vrhat se do nových výzev a objevovat neznámé obzory. Mají pozoruhodnou schopnost zahajovat projekty, inspirovat ostatní svými nápady a neustále posouvat věci kupředu. Jejich ohnivá povaha se projevuje dvěma způsoby: buď jako neklidní dobrodruzi bořící stereotypy, nebo trpěliví stavitelé, kteří systematicky tvoří nové struktury. Často v sobě nesou přirozenou autoritu – vůdčí charisma schopné strhnout ostatní svými divokými vizemi, nebo naopak hluboké soustředění, které je vede k úspěchu v dlouhodobých cílech. V nitru Beranů plane oheň, který je žene kupředu – a právě to z nich dělá skutečné nositele změn.",

                "archetype": {
                    "extra": "Extroverti bývají hluční a rádi organizují ostatní kolem sebe.",
                    "intro": "Introverti směřují svou energii do tvořivosti nebo sportu."
                },

                "planet": "Mars, vládce Berana, odhaluje překvapivou mnohotvárnost tohoto znamení. Římané v Marsovi viděli nejen boha války, ale i ochránce – jeho zuřivost byla posvátná, zaměřená na obranu slabých a udržení pořádku. Tento pohled zvýrazňuje hlubší stránku Beranů – jejich síla tkví ve schopnosti překonávat překážky a chránit to, na čem jim záleží. Řecký Áres, byť impulzivnější a nemilosrdnější, také odráží beraní aspekt – jejich ohnivá energie může být divoká, ale zároveň tvořivá. V kontextu Marsu je klíčové, že tento plamen spíše tvoří než ničí – žene je k dosažení cílů a naplnění vizí. Mars představuje vášeň, iniciativu a životní sílu, díky čemuž jsou Berani zdrojem inspirace pro své okolí. Jeho symbolika je spojena také s cykly plodnosti a růstu, čímž do beraní povahy vnáší i péči a zodpovědnost. Nejenže dokážou vést ostatní, ale zároveň budují základy pro trvalý rozvoj – jejich síla jde ruku v ruce s něhou.",

                "mythology": {

                    "pic": "./assets/images/myth/ariesMyth/aries.jpg",
                    "main": "Legenda o Zlatém rounu pozoruhodně rezonuje s podstatou Berana – spojuje v sobě hrdinství, vnitřní sílu a touhu po dobrodružství. Zlatý beran seslaný bohy se stává symbolem nejen záchrany a obětování, ale také začátku velké cesty. Beran jako znamení ztělesňuje ochotu postavit se osudu, bránit to, co je důležité, a dosáhnout vyššího cíle. Výprava Argonautů vedená Iásonem je klasickým příkladem odvahy a vůdcovství, které jsou pro Berany typické. Iáson skutečně reprezentuje rysy typického Berana: cílevědomost, rozhodnost a odvahu čelit i těm největším překážkám. Jeho bezhlavost však ukazuje i druhou stránku Berana – touhu dosáhnout cíle i za cenu přehlédnutí rizik. Zlaté rouno zde symbolizuje nejen materiální hodnotu, ale především nejvyšší ambici, která inspiruje a spojuje. Pro Berany je to metafora vrozené touhy po činech a schopnosti vést ostatní i cestou plnou nástrah.",

                    "branch1": {
                        "title": "Legenda o Frixovi a Hellé",
                        "pic": "./assets/images/myth/ariesMyth/gella.jpg",
                        "description": "Frixos a Hellé byli dětmi krále Athamanta z Orchomenu a jeho první manželky Nefely. Jejich macecha Ínó je však nenáviděla a plánovala se jich zbavit. Přesvědčila Athamanta, že je třeba obětovat obě děti, aby skončilo sucho v zemi. Nefelé, toužící děti zachránit, jim poslala na pomoc kouzelného zlatého berana, kterého dostala od Dia. Beran zvedl Frixa s Hellé do vzduchu a začal přelet přes moře. Během letu se Hellé neudržela a spadla do moře, kde se utopila v průlivu, který je dnes známý jako Hellespont (současné Dardanely). Frixos dorazil bezpečně do Kolchidy, kde ho přijal král Aiétés. Na znamení vděčnosti obětoval berana Diovi a zlaté rouno předal Aiétovi, který ho ukryl v posvátném háji pod ochranou draka."
                    },

                    "branch2": {
                        "title": "Legenda o Jásonovi a Argonautech",
                        "pic": "./assets/images/myth/ariesMyth/argo.jpg",
                        "description": "Zlaté rouno bylo kouzelnou kůží zlatého berana, darovaného bohem Diem. Hlídal ho drak ve svatém háji v Kolchidě. Jáson se vydal na cestu za Zlatým rounem, aby navrátil trůn svému otci. Spolu s výpravou hrdinů zvaných Argonauti vyplul na lodi Argo. Po mnoha dobrodružstvích a zkouškách dorazili do Kolchidy. Král Aiétés Jásónovi uložil nelehké úkoly – zkrotit dva ohnivé býky, zorat s nimi pole, zasít dračí zuby, ze kterých vzešli ozbrojení bojovníci, a ty přemoci. Jáson uspěl díky pomoci Médeie, královy dcery, která se do něj zamilovala. Nakonec spolu ukradli Zlaté rouno – Médeia draka uspala kouzelným elixírem. Spolu s Argonauty se vrátili domů, překonávajíc další nebezpečí na cestě zpět."
                    },

                },

                "facts": [
                    ["Na ostří nože:", "Psychologické výzkumy ukazují, že lidé narození v tomto znamení často inklinují k profesím spojeným s rizikem nebo kreativitou."],
                    ["Dualita Marta:", "V Římě byl Mars nejen bohem války, ale i ochráncem plodnosti – Beran v sobě nese tuto dvojí povahu: ničení jako cesta k tvoření."],
                    ["Rovnodennost:", "Ve starověkém Řecku Beran otevíral astrologický rok jako symbol jarní rovnodennosti a vítězství světla nad temnotou."],
                    ["Oráč:", "V babylonské astrologii bylo souhvězdí Berana známo jako „Pracovník“ – už tehdy byli považováni za neúnavné dříče."]
                ],

            },

            "childhood": {
                "description": "Berani v dětství často vyzařují radost a zvědavost. Jejich energie nezná hranic – neustále zkoumají svět kolem sebe a hledají nové zážitky. Obvykle rádi přitahují pozornost a stávají se přirozenými vůdci mezi vrstevníky. Čas od času projevují impulzivitu a touhu být ve všem první. Někdy ale mohou být i plaší, zvlášť v nových situacích.",

                "perks": [
                    ["Energie:", "Jsou aktivní a plní životní síly."],
                    ["Tvořivost:", "Projevují fantazii a kreativitu."],
                    ["Rozhodnost:", "Jsou si často jisti svými činy a rozhodnutími."],
                    ["Impulzivnost:", "Jednají někdy unáhleně, bez promyšlení důsledků."],
                    ["Tvrdohlavost:", "Bývají velmi houževnatí a neradi ustupují."],
                    ["Nesoustředěnost:", "Mají potíže s klidem a koncentrací."]
                ]
            },

            "schoolboy": {
                "description": "Berani ve školních letech obvykle projevují zájem o sport a aktivní činnosti. Často vynikají v předmětech spojených s pohybem, jako je tělesná výchova. Někdy je zvlášť přitahují týmové sporty, kde mohou zastávat roli kapitána a inspirovat své spoluhráče. Mají přirozený sklon k vedení ve školních projektech i mimoškolních aktivitách. Často se zapojují do studentských rad a kroužků, kde mohou uplatnit své ambice a vytrvalost. Jejich potřeba aktivity však může způsobovat obtíže při výuce, která vyžaduje dlouhou pozornost a soustředění, například v matematice či dějepisu. Berani často jeví živý zájem o experimentální vědy a kreativní předměty jako výtvarná výchova či praktické dílny. Jejich zvídavost a chuť objevovat nové znalosti z nich někdy dělají hvězdy při laboratorních pracích a projektech, kde mohou své nápady realizovat. Občas narážejí na potíže ve vztazích s učiteli a spolužáky kvůli své přímočarosti a smyslu pro spravedlnost. Jejich poctivost a snaha něco dokázat jim ale většinou pomáhá tyto konflikty překonat a najít společnou řeč s okolím.",

                "inclinations": [
                    ["Sport:", "Fotbal, běh, bojová umění – zkrátka kdekoliv, kde se dá uvolnit energie."],
                    ["Tvořivost:", "Kreslení, divadlo, hudba – pokud se mohou projevit."],
                    ["Přírodní vědy:", "Fyzika nebo chemie, zvlášť pokud zahrnují pokusy."]
                ],

                "perks": [
                    ["Improvizace:", "Řeší úlohy originálně, ale někdy přeskočí důležité kroky."],
                    ["Konflikty:", "Hájí se proti nespravedlnosti, často diskutují s učiteli."],
                    ["Nesoustředěnost:", "Ve třídě bývají neklidní, kreslí si nebo sní o dobrodružstvích."]
                ]
            },

            "adult": {
                "description": "Dospělí Berani se často stávají vůdci, ale jejich cesta nebývá jednoduchá. V touze po vrcholech čelí mnoha výzvám a překážkám. Jejich hlad po svobodě a odpor k rutině je vede k hledání nových cest a příležitostí – i když to obnáší velké úsilí a riziko. Touha po nezávislosti však může přinášet nestabilitu a potíže s udržením rovnováhy mezi pracovním a osobním životem. Neustálá potřeba pohybu vpřed jim někdy brání naplno si vychutnat přítomnost a ocenit již dosažené. V osobním životě často hledají intenzivní a vášnivé vztahy. Umí být oddanými a upřímnými partnery, ale potřebují někoho, kdo podpoří jejich ambice a bude jim rovnocenným protějškem ve snaze dobývat nové obzory. Aby dosáhli harmonického a dlouhodobého vztahu, je pro Berany klíčové najít rovnováhu mezi vlastními potřebami a potřebami partnera.",

                "perks": [
                    ["Ambicióznost:", "Staví si vysoké cíle, i když šance na úspěch nejsou velké."],
                    ["Rozhodnost:", "Rozhodují se rychle, často podle intuice."],
                    ["Nadšení:", "Naplňují své okolí vírou v úspěch."],
                    ["Netrpělivost:", "Rychle ztrácejí zájem, pokud není výsledek okamžitý."],
                    ["Konfliktnost:", "Těžko ustupují, pokud jsou přesvědčeni o své pravdě."],
                    ["Egocentrismus:", "Občas zapomínají, že i druzí mají své potřeby."]
                ]
            },

            "oldman": {
                "description": "Berani i ve stáří zůstávají aktivní a plní energie. Jen málokdy se smíří s monotonií nebo rutinou – stále touží po novém a neprozkoumaném. Jejich životní síla a touha po svobodě jim umožňují nacházet inspiraci i v pozdních letech, díky čemuž zůstává jejich život pestrý a naplněný. Často však mají problém přijmout klidnější tempo života. Jejich vnitřní neklid a chuť jednat mohou vést k nespokojenosti a hledání nových výzev. Přesto jim nahromaděná moudrost a zkušenosti pomáhají překonávat těžkosti a nacházet radost v každodennosti.",

                "perks": [
                    ["Aktivita:", "V sedmdesáti se klidně přihlásí na tanec nebo začnou studovat cizí jazyk."],
                    ["Zvídavost:", "Zajímají se o technologie, cestování nebo nová hobby."],
                    ["Paličatost:", "Odmítají pomoc, i když ji skutečně potřebují."],
                    ["Kritičnost:", "Rozčilují se, když je „mládež příliš pomalá“."]
                ]
            },

            "work": {
                "description": "Berani jsou v práci hybnou silou změn – jejich energie a odvaha často fungují jako katalyzátor pokroku. Jejich profesní dráha málokdy sleduje přímou linii: mění obory, projekty či dokonce cíle, pokud je přestane výzva naplňovat. Nezabývají se neúspěchy – jejich motto zní: „Shořel? Tak zahoř znovu.“ I v krizi hledají příležitosti spíš než důvody k lítosti. Měli by se však učit chybám, ne je jen zapomínat. Vynikají tam, kde je třeba leadership a iniciativa. Rozhodují se rychle a nebojí se zodpovědnosti. Jejich energie často stačí k vybudování vlastního byznysu nebo k vedení týmu. Ne každý Beran je rozený CEO – mnozí se uplatní jako „svobodní střelci“, experti či mentoři, kde se mohou rozdat, aniž by je svazovala byrokracie. Hlavní je, aby jejich práce znamenala pohyb vpřed – třeba i přes překážky.",

                "perks": [
                    ["Vyhoření:", "Jejich vnitřní „oheň“ potřebuje pravidelné podněty – bez nových cílů nebo uznání mohou ztrácet motivaci."],
                    ["Impulzivní akčnost:", "Nejprve skočí, pak přemýšlí – v rychlém prostředí (start-upy, krizové řízení) je to výhoda."],
                    ["Schopnost inspirovat:", "Dokážou nadchnout i v obyčejné roli, přetvářejí rutinu v dobrodružství."],
                    ["Adaptabilita:", "Rychle se přizpůsobí novým podmínkám – nebojí se opustit staré metody."],
                    ["Sklon k riziku:", "Investují do odvážných nápadů – občas je to průlom, občas lekce, na kterou nezapomenou."],
                    ["Nesnášenlivost rutiny:", "Můžou ztratit zájem při opakovaných či byrokratických úkolech."],
                    ["Konfliktnost:", "Přímočarost může vést ke sporům, hlavně pokud cítí nespravedlnost."]
                ],

                "conditions": [
                    ["Volnost v rozhodování:", "Přehnaný dohled a mikromanagement likvidují jejich zápal."],
                    ["Možnost růstu:", "Kariérní postup je pro Berana jako rudá vlajka pro býka."],
                    ["Dynamické prostředí:", "Krize, brainstorming, změny – tady se cítí jako ryba ve vodě."]
                ],

                "professions": [
                    ["Inovace:", "Vývoj nových produktů, digitální technologie, kreativní odvětví."],
                    ["Záchranné složky:", "Hasiči, záchranáři, vojáci – kde je třeba rychlost a odvaha."],
                    ["Podnikání:", "Vlastní byznys – spojení rizika, kreativity a svobody."],
                    ["Sport a aktivní profese:", "Trenéři, outdoor průvodci, profesionální sportovci."]
                ]
            },
            ...
            "relationships": {
                ...
                "romantic": {
                    "description": "Berani v romantických vztazích projevují vášeň a nadšení. Do vztahů vkládají spoustu energie a chtějí, aby byly intenzivní a nezapomenutelné. Díky své aktivitě a odhodlání jsou oddanými a zanícenými partnery. Jejich impulzivnost a potřeba kontroly však mohou občas působit potíže. Je důležité, aby se Berani naučili respektovat potřeby a přání druhého, aby se předešlo nedorozuměním a konfliktům. Hledají partnery, kteří sdílejí jejich ambice a touhu objevovat nové horizonty. Oceňují otevřenost a upřímnost a usilují o harmonický, dlouhodobý vztah. Klíčem ke štěstí je pro ně rovnováha mezi vlastními touhami a potřebami partnera."
                },

                "friend": {
                    "description": "V přátelství se Berani projevují jako loajální a aktivní společníci. Jejich energie a nadšení z nich dělají skvělé parťáky pro dobrodružství a zábavu. Rádi tráví čas s přáteli – ať už při výletech, sportovních akcích nebo u šálku kávy. Někdy se ale může projevit jejich impulzivita a snaha o dominanci, což může vést ke komplikacím. Důležité je, aby se naučili brát ohled i na názory a přání druhých. Hledají přátele, kteří podpoří jejich ambice a budou sdílet chuť poznávat nové věci. Ocení otevřenost a férovost – chtějí budovat hluboké a trvalé přátelské vazby postavené na vzájemném respektu."
                },

                "foe": {
                    "description": "Ve vztazích s protivníky Berani projevují svou odhodlanost a energii naplno. Nevyhýbají se konfrontaci a často bojují za své přesvědčení a zájmy. Jejich odvaha a sebedůvěra z nich dělají silné protivníky, kteří se nebojí hájit vlastní pozici. Impulzivita a snaha mít situaci pod kontrolou ale mohou vést k ostrým konfliktům. Bývají přímočaří a ne vždy berou ohled na pocity druhých, což může vyvolávat nepřátelství. Umí však uplatnit své vůdcovské schopnosti a strategické myšlení. Klíčem je najít rovnováhu mezi rozhodností a respektem k druhým. Jejich smysl pro spravedlnost a schopnost postavit se za sebe z nich dělají silné soupeře – ale zůstává důležité nezapomínat na úctu a schopnost kompromisu."
                }
...

        {
            ...
            "description": {
                ...
                "common": "Býci jsou stabilizátory zvěrokruhu – ztělesňují spolehlivost a pevnost. Tento zemský znak je spojen s římskou bohyní lásky Venuší, což Býkům propůjčuje krásu a smyslnost. Touží po pohodlí a bezpečí, stejně jako země, po níž kráčejí. Jejich zemská podstata se však může projevovat různě: někteří Býci jsou neochvějnými obhájci svých hodnot, jiní tvoří trpělivě a vytrvale stabilní a harmonické vztahy.",

                "archetype": {
                    "extra": "Extroverti otevřeně vyjadřují své city a aktivně se zapojují do společenského života.",
                    "intro": "Introverti směřují svou energii do vytváření útulného a vyváženého prostředí kolem sebe."
                },

                "planet": "Vládcem znamení Býka je Venuše. Tato planeta, pojmenovaná po římské bohyni lásky a krásy, není jen symbolem romantiky – ve starověkých kulturách ztělesňovala také harmonii přírody, plodnost a hojnost. Její řecký protějšek, Afrodita, byla spojována se smyslností a vášní, zatímco Římané vnímali Venuši i jako ochránkyni zemědělství, umění a materiálního blahobytu. Pro Býka je tento aspekt klíčový: jeho energie nesměřuje k prchavému potěšení, ale k budování trvalého, estetického a pohodlného života. Venuše reprezentuje lásku k pěkným věcem, smyslové prožitky a schopnost ocenit hmotný svět.",


                "mythology": {

                    "pic": "./assets/images/myth/taurusMyth/minotaur.jpg",
                    "main": "Symbol Býka je spojen s legendou o Diově býkovi. V řeckých mýtech se Zeus proměnil v nádherného bílého býka, aby unesl krásnou Europu a dopravil ji na Krétu. Také legenda o Minotaurovi souvisí s tímto zvířetem – obě mytologické příběhy zdůrazňují sílu, vytrvalost a přitažlivost, které jsou pro Býky typické. Býci jsou známí svou spolehlivostí a touhou po stabilitě – podobně jako býk, který pevně stojí na zemi. Jejich zemská energie je zaměřena na budování pevných základů a harmonických vztahů.",


                    "branch1": {
                        "title": "Legenda o Diově býkovi",
                        "pic": "./assets/images/myth/taurusMyth/whiteBull.jpg",
                        "description": "Legenda o Diově býkovi vychází ze starořeckého mýtu o únosu princezny Europy. Zeus, nejvyšší bůh Olympu, byl uchvácen její krásou – a aby se k ní přiblížil, proměnil se v nádherného bílého býka se zlatými rohy a ušlechtilým vzhledem. Když Europa se svými přítelkyněmi trávila čas na mořském pobřeží, zaujala ji krása a klidná povaha býka. Přistoupila k němu, začala ho hladit a zdobit květinami jeho rohy. Když jí připadal naprosto neškodný, posadila se mu na hřbet – a tehdy Zeus vyrazil k moři a přeplaval s ní až na Krétu. Tam odhalil svou pravou podobu a vyznal jí lásku. Spolu se stali rodiči několika dětí, včetně slavného krále Minóa a soudce podsvětí Rhamantha. Tento mýtus vyzdvihuje sílu, přitažlivost a klidnou rozhodnost Býka. Podobně jako Zeus v podobě býka, i Býci působí vyrovnaně, ale jejich vnitřní síla a vytrvalost jim pomáhají dosahovat cílů a chránit to, co milují."
                    },

                    "branch2": {
                        "title": "Legenda o Minotaurovi",
                        "pic": "./assets/images/myth/taurusMyth/fight.jpg",
                        "description": "Minotaurus vznikl v důsledku kletby, která postihla manželku krále Mínóa. Král požádal boha moří Poseidóna, aby mu seslal bílého býka jako oběť. Poseidón mu vyhověl a poslal nádherného býka, ale Mínós byl tak ohromen jeho krásou, že ho odmítl obětovat a nahradil ho jiným. Poseidón se rozzlobil a potrestal ho tak, že způsobil, aby se Mínóova žena Pasifaé do býka zamilovala. Z tohoto svazku se narodil Minotaurus – bytost s tělem člověka a hlavou býka. Mínós, otřesený tímto zrodem, nechal pro Minotaura postavit Labyrint, složitou stavbu navrženou Daidalem, kde mělo být monstrum skryto a izolováno. Labyrint byl natolik složitý, že nikdo, kdo do něj vstoupil, nenašel cestu ven. Každých několik let posílaly Athény na Krétu skupinu mladých lidí jako oběť Minotaurovi. Hrdina Théseus, syn athénského krále Aigea, se rozhodl této praxi učinit přítrž. Dobrovolně odplul na Krétu, kde mu králova dcera Ariadna – zamilovaná do něj – darovala kouzelný klubko nitě, které měl rozmotávat, aby našel cestu zpět. Théseus Minotaura porazil a díky niti se z Labyrintu bezpečně vrátil."
                    },

                },

                "facts": [
                    ["Hospodář:", "Býci mají často silnou fyzickou výdrž a lásku k přírodě, což z nich dělá výborné zahrádkáře a zemědělce."],
                    ["Krása a umění:", "Znamení Býka je často spojováno s estetikou a uměním – mnoho slavných umělců a hudebníků se narodilo právě v tomto znamení."],
                    ["Finanční talent:", "Venuše, vládnoucí planeta Býka, ovlivňuje nejen lásku a krásu, ale také finance – Býci často vynikají v hospodaření s penězi."],
                    ["Neústupnost:", "Býci jsou známí svou vytrvalostí a odhodláním, které jim pomáhá dosahovat cílů i navzdory překážkám."]
                ],

            },

            "childhood": {
                "description": "Býci v dětství často působí klidně a vyrovnaně. Milují stabilitu a pohodlí a dávají přednost známému a ověřenému prostředí. Obvykle se vyznačují trpělivostí a vytrvalostí, které jim pomáhají dosahovat svých cílů. Někdy jsou tvrdohlaví ve svých přáních, ale zároveň projevují péči o své blízké i okolí.",

                "perks": [
                    ["Trpělivost:", "Klidně a vytrvale směřují ke svým cílům."],
                    ["Stabilita:", "Cítí se nejlépe v pevném a předvídatelném prostředí."],
                    ["Vytrvalost:", "Nevzdávají se před překážkami a jdou si za svým."],
                    ["Praktičnost:", "Mají racionální a účelný přístup k řešení problémů."],
                    ["Tvrdohlavost:", "Někdy nechtějí ustoupit a trvají na svém."],
                    ["Zatvrzelost:", "Hůře se přizpůsobují změnám a novým situacím."]
                ]
            },

            "schoolboy": {
                "description": "Býci ve školních letech obvykle vynikají svou pečlivostí a trpělivostí. Upřednostňují stálost a dobře si vedou v úkolech, které vyžadují soustředění na detail. Často se jim daří v předmětech, kde hrají roli vytrvalost a praxe – například v matematice nebo výtvarné výchově. Mají sklony k tvořivým i praktickým činnostem, kde mohou převést své nápady do reality. Rádi vytvářejí kolem sebe harmonické prostředí, což z nich často činí oblíbené spolužáky. Jsou zodpovědní a spolehliví, díky čemuž si získávají důvěru učitelů a vrstevníků. Někdy ale jejich tvrdohlavost a potřeba stálosti ztěžují přizpůsobení se novým metodám výuky. Mohou také pracovat pomaleji, což někdy rozčiluje okolí. Někdy se příliš zaměřují na vlastní cíle a méně vnímají potřeby skupiny.",

                "inclinations": [
                    ["Umění:", "Kresba, sochařství – tam, kde je prostor pro kreativitu a cit pro detail."],
                    ["Přírodní vědy:", "Matematika, biologie – pokud lze využít logiku a důslednost při řešení úloh."],
                    ["Praktická výuka:", "Dílny, zahradnictví – když je možné převést nápady do hmotné podoby."]
                ],

                "perks": [
                    ["Píle:", "Dokážou dlouho a soustředěně pracovat na úkolech."],
                    ["Zodpovědnost:", "Snaží se plnit úkoly kvalitně a včas."],
                    ["Pomalost:", "Někdy postupují pomaleji než ostatní, což může být frustrující."],
                    ["Obtížná adaptace:", "Mají potíže přizpůsobit se novým podmínkám a metodám učení."]
                ]
            },


            "adult": {
                "description": "Dospělí Býci bývají oporou a zdrojem stability pro své blízké. Cení si pohodlí a bezpečí a usilují o harmonický a vyrovnaný život. Díky své vytrvalosti a praktičnosti dokážou dosahovat dlouhodobých cílů – i když to vyžaduje čas a úsilí. Jejich snaha o stabilitu ale někdy vede k odporu vůči změnám a obtížím při přizpůsobování se novým okolnostem. V osobním životě touží po pevném a trvalém vztahu. Jsou starostliví a oddaní partneři, ale potřebují mít vedle sebe někoho, kdo je podpoří a vytvoří s nimi pocit jistoty. Pro Býky je klíčové najít rovnováhu mezi touhou po jistotě a ochotou ke kompromisu, aby mohli budovat harmonický a dlouhodobý vztah.",

                "perks": [
                    ["Vytrvalost:", "Pokračují v úsilí navzdory překážkám."],
                    ["Praktičnost:", "Umí realisticky zhodnotit situaci."],
                    ["Péče:", "Projevují zájem a starost o své blízké."],
                    ["Paličatost:", "Jednají podle sebe, bez ohledu na názory okolí."],
                    ["Setrvačnost:", "Někdy se brání novinkám a změnám."],
                    ["Flegmatičnost:", "Rozhodují se pomalu, protože si vše důkladně promýšlejí."]
                ]
            },


            "oldman": {
                "description": "Býci ve stáří často působí jako symbol stability a klidu. Cení si pohodlí a nejlépe se cítí v prostředí, které dobře znají. I ve vyšším věku zůstávají věrní svým návykům a životnímu rytmu. Díky své vytrvalosti a trpělivosti si dokážou užívat plody své práce a starat se o své blízké. Jejich potřeba jistoty je však někdy vede k odmítání nových zkušeností nebo změn. Pro plnohodnotný a obohacující život je pro ně důležité najít rovnováhu mezi touhou po stálosti a otevřeností vůči novým zážitkům.",

                "perks": [
                    ["Péče:", "Projevují pozornost a starost o svou rodinu a přátele."],
                    ["Výdrž:", "Trpělivě čekají na výsledky svého úsilí."],
                    ["Zkostnatělost:", "Mohou být uzavření vůči změnám a novinkám."],
                    ["Tradičnost:", "Dávají přednost osvědčeným zvykům a vyhýbají se riziku."]
                ]
            },

            "work": {
                "description": "Býci v práci často působí jako spolehliví a zodpovědní zaměstnanci. Jejich profesní cesta bývá stabilní a postupná. Dávají přednost oblastem, kde mohou využít svou vytrvalost a praktičnost. Oceňují pohodlné a předvídatelné pracovní prostředí, které jim umožňuje systematicky dosahovat stanovených cílů. Snaží se o dlouhodobé pracovní vztahy a stabilní kariérní růst. Díky své houževnatosti překonávají překážky, i když mohou mít potíže přizpůsobit se náhlým změnám nebo inovacím.",

                "perks": [
                    ["Spolehlivost:", "Lze se na ně spolehnout – jen zřídka zklamou."],
                    ["Praktičnost:", "Řeší problémy realisticky a zaměřují se na hmatatelné výsledky."],
                    ["Neochota ke změnám:", "Upřednostňují zavedený řád a mohou odolávat novinkám."],
                    ["Setrvačnost:", "Nové nápady a metody přijímají pomalu, dávají přednost osvědčenému."]
                ],

                "conditions": [
                    ["Stabilní pracovní prostředí:", "Předvídatelnost jim dodává pocit jistoty a klidu."],
                    ["Prostor k soustředění:", "Raději pracují v klidném prostředí bez zbytečného ruchu."],
                    ["Jasné úkoly:", "Mají rádi přesně definované cíle a konkrétní zadání."]
                ],

                "professions": [
                    ["Finanční sektor:", "Účetnictví, správa financí – tam, kde je potřeba přesnost a pečlivost."],
                    ["Zemědělství a zahradnictví:", "Práce s půdou a rostlinami, tvorba krásných a plodných zahrad."],
                    ["Architektura a design:", "Navrhování estetických a funkčních prostor, budov a interiérů."],
                    ["Umění a řemesla:", "Tvůrčí práce – šperkařství, keramika nebo textilní tvorba."]
                ]
            },
            ...
            "relationships": {
                ...
                "romantic": {
                    "description": "Býci jsou v romantických vztazích věrní a pečující. Usilují o stabilní a harmonické partnerství, do kterého vkládají svůj čas i energii. Díky vrozené trpělivosti a vytrvalosti jsou spolehlivými a oddanými partnery. Někdy však jejich touha po stálosti a tvrdohlavost mohou vztah komplikovat. Je důležité, aby dokázali respektovat potřeby a přání svého partnera, aby předešli nedorozuměním. Hledají partnera, který ocení jejich péči a oporu. Oceňují pohodlí a útulnost vztahu a chtějí vybudovat dlouhodobý a vyvážený svazek. K dosažení štěstí ve vztahu je pro ně klíčové najít rovnováhu mezi vlastními potřebami a těmi partnerovými."
                },

                "friend": {
                    "description": "V přátelství se Býci projevují jako věrní a starostliví přátelé. Jejich spolehlivost a trpělivost z nich dělají skvělé společníky pro klidné trávení času i hluboké rozhovory. Rádi tráví chvíle v příjemném prostředí – pikniky, domácí setkání nebo procházky v přírodě jsou jim blízké. Někdy však jejich tvrdohlavost a lpění na stálosti mohou přinést složitosti ve vztazích. Je důležité, aby dokázali naslouchat a respektovat přání druhých. Cení si přátel, kteří vnímají jejich péči a důslednost. Usilují o dlouhodobá a harmonická přátelství, ve kterých panuje vzájemný respekt a pohoda."
                },

                "foe": {
                    "description": "V konfliktních vztazích Býci plně uplatňují svou vytrvalost a houževnatost. Nevyhýbají se konfrontacím a nebojí se hájit své hodnoty. Jejich klidná sebedůvěra z nich dělá silné protivníky, kteří jsou odhodláni držet si své pozice. Tvrdohlavost a potřeba neměnnosti však mohou způsobovat dlouhotrvající spory. Býci bývají přímočaří a někdy nevnímají citlivost druhých, což může vést k nepřátelství. Přesto dokážou projevit strategické myšlení a vytrvalost i v napjatých vztazích. Klíčové je, aby se naučili vyvažovat rozhodnost s respektem a uměním kompromisu – jejich síla je cenná, když ji doprovází vnitřní klid a úcta k druhým."
                }
...

        {
            ...
            "description": {
                ...
                "common": "Blíženci jsou komunikačním znamením, které ztělesňuje inteligenci a zvídavost. Tento vzdušný znak je v řecké mytologii spojován s bohem obchodníků a cestovatelů Hermem, což Blížencům propůjčuje výřečnost a pohyblivost. Usilují o výměnu znalostí a sbírání nových zkušeností – jako vítr, který se nikdy nezastaví. Jejich vzdušná podstata se ale může projevovat různě: někteří Blíženci jsou neklidní dobrodruzi, jiní moudří učitelé a průvodci, kteří sdílejí své poznatky a zkušenosti.",

                "archetype": {
                    "extra": "Extroverti aktivně vyhledávají nová přátelství a účastní se mnoha společenských událostí, radují se z komunikace a sdílení nápadů.",
                    "intro": "Introverti obracejí svou zvídavost dovnitř – do studia rozmanitých témat a osobního rozvoje, dávají přednost klidným a intelektuálním činnostem."
                },

                "planet": "Vládnoucí planetou Blíženců je Merkur. Tento planetární posel, pojmenovaný po římském bohu obchodu a cestování, je symbolem komunikace, intelektu a rychlého pohybu. V dávných kulturách ztělesňoval bystré myšlení, obratnost a přizpůsobivost. Jeho řecký protějšek Hermes byl spojován s předáváním zpráv a sdílením vědění. Právě to je pro Blížence zásadní: jejich energie směřuje k učení, výměně informací a zkoumání nových oblastí poznání. Merkur zosobňuje intelektuální zvědavost, hlad po informacích a schopnost efektivně komunikovat s okolím.",
